...
namespace Drelanium.Extensions.IActionExtensionMethods
{
    ...
    public static class IActionExtensionMethods
    {
        ...
        public static void PerformWithCondition(this IAction action, WebDriverWait wait, Func<IWebDriver, bool> condition, Logger logger = null)
        {
            logger?.Information($"Performing chained actions and waiting for condition until {wait.Timeout.TotalSeconds}");
