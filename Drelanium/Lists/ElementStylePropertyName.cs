...
namespace Drelanium.Lists
{
    ...
    public class ElementStylePropertyName
    {
        ...
        public static ElementStylePropertyName Borderimagesource => new ElementStylePropertyName("border-image-source");
        ...
        public static ElementStylePropertyName Liststyleposition => new ElementStylePropertyName("list-style-position");
        ...
        public static ElementStylePropertyName Margininlinestart => new ElementStylePropertyName("margin-inline-start");
        ...
        public static ElementStylePropertyName Paddingblockstart => new ElementStylePropertyName("padding-block-start");
