...
namespace TestCommon
{
    ...
    public class CommonStepMethods
    {
        ...
        public static string HttpResponseKey = "HttpResponse";
        public static string HttpResponseDictionaryKey = "HttpResponseDictionaryKey";
