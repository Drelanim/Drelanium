...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("launch google")]
        [NUnit.Framework.TestCaseAttribute("CHROME", null)]
        [NUnit.Framework.TestCaseAttribute("FIREFOX", null)]
        public virtual void LaunchGoogle(string browser, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("launch google", null, exampleTags);
#line 5
...
#line 7
 testRunner.Given("Google is launched on url http://google.com", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
