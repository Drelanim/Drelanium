...
namespace TestCommon
{
    public class SeleniumPageBase
    {
        ...
        // constructor, requires browser option object to intialize remote driver, overloads per browser type to allow additional initialization action
        public SeleniumPageBase(FirefoxOptions browserOptions)
        {
            Uri seleniumGridUri = new Uri(ConfigurationManager.AppSettings["SeleniumHubUrl"]);
            Driver = new RemoteWebDriver(seleniumGridUri, browserOptions.ToCapabilities());
        }
        public SeleniumPageBase(EdgeOptions browserOptions)
        {
            Uri seleniumGridUri = new Uri(ConfigurationManager.AppSettings["SeleniumHubUrl"]);
            Driver = new RemoteWebDriver(seleniumGridUri, browserOptions.ToCapabilities());
        }
        public SeleniumPageBase(ChromeOptions browserOptions)
        {
            Uri seleniumGridUri = new Uri(ConfigurationManager.AppSettings["SeleniumHubUrl"]);
            Driver = new RemoteWebDriver(seleniumGridUri, browserOptions.ToCapabilities());
        }
        public SeleniumPageBase(InternetExplorerOptions browserOptions)
        {
            Uri seleniumGridUri = new Uri(ConfigurationManager.AppSettings["SeleniumHubUrl"]);
            Driver = new RemoteWebDriver(seleniumGridUri, browserOptions.ToCapabilities());
        }
