...
namespace Drelanium.BDD
{
    ...
    ///     <para>Use <see cref="GivenAttribute" /> | <see cref="WhenAttribute" /> | <see cref="ThenAttribute" /> attributes for StepDefinition methods.</para>
    ///     <para>Use <see cref="BeforeTestRunAttribute" /> | <see cref="AfterTestRunAttribute" /> for TestRun SetUp and TearDowns.</para>
    ///     <para>Use <see cref="BeforeFeatureAttribute" /> | <see cref="AfterFeatureAttribute" /> for Feature SetUp and TearDowns.</para>
    ///     <para>Use <see cref="BeforeScenarioAttribute" /> | <see cref="AfterScenarioAttribute" /> for Scenario SetUp and TearDowns.</para>
