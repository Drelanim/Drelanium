...
namespace Drelanium
{
    ...
    /// </summary>
    public static class FindSelectedElementMethods
    {
        /// <summary>
        ///     Finds the first <see cref="IWebElement" /> using the given method, then waits until the element becomes Selected.
            ...
            [CanBeNull] Logger logger = null)
        {
            ...
            searchContext
                ...
                .UntilElementIsSelected(searchContext, locator);

            logger?.Information($"Selected element ({locator}) has been found.");
